...
var _user$project$Messages$OnFetchPage = function (a) {
...
var _user$project$Commands$fetchPage = A2(
	...
	_user$project$Messages$OnFetchPage,
	_user$project$RemoteData$sendRequest(
		A2(_elm_lang$http$Http$get, _user$project$Commands$fetchPageUrl, _user$project$Page_Commands$pageDecoder)));

var _user$project$Models$initialCommands = _user$project$Commands$fetchPage;
var _user$project$Models$initialModel = {page: _user$project$RemoteData$Loading};
...
var _user$project$Page_View$page = function (x) {
	return _user$project$Bootstrap$mdContent(
		{
			ctor: '::',
			_0: _user$project$Bootstrap$mdTitle(x.title),
			_1: {
				ctor: '::',
	...
	switch (_p0.ctor) {
		...
		default:
			return A2(
				...
				_user$project$Messages$PageMsg,
				_user$project$Page_View$page(_p0._0));
	}
};
