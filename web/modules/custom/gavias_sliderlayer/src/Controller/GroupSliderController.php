...
class GroupSliderController extends ControllerBase {
  ...
  public function gavias_sl_group_list(){
    ...
    foreach ($results as $row) {
      ...
      $tmp[] = $row->id;
      $tmp[] = $row->title;
      $tmp[] = t('<a href="@link_1">Edit Name</a> | <a href="@link_2">List Silders</a> | <a href="@link_3">Config Gerenral</a> | <a href="@link_5">Clone</a> | <a href="@link_6">Export</a> | <a href="@link_7">Import</a> | <a href="@link_4">Delete</a>', array(
